  ...
  <body class="login">
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form" style="border:1px solid black;border-radius: 20px ;">
          <section class="login_content">
            <form method="post">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> My Shop</h1>
                  <p>©2021 All Rights Reserved. My Shop</p>
                </div>
              </div>
            </form>
          </section>
